...
myWeatherData= LOAD 'WeatherOutput/part-r-00000' USING PigStorage(',') AS (month:chararray, typeofdata:chararray, stationid:chararray, count:chararray, maxval:chararray, minval:chararray, avgval:chararray);
